...
#define STRING_CONFIG_H_AUTHOR "(z-unlimited 0.1 AH)" //Who made the changes.
...
// joris -z-unlimited 2014-07-22
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7402,78.7402,1360.0,836}  // default steps per unit for Ultimaker adjusted for z-unlimited
